...
export default function Exercise1({ onCorrect, onWrong }: Props) {
    return (
        <View style={styles.root}>
            <Pressable style={StyleSheet.absoluteFill} onPress={onWrong} />
            <View style={styles.content} pointerEvents="box-none">
                <TutorialAvatar mood="neutral" />
                <VoiceBubble text="Mira… Quiere jugo. Toca el jugo." />
                <Text style={styles.hint}>toca el pictograma del jugo</Text>
                <View style={styles.pictoWrap}>
                    ...
                    >
                        ...
                        <Text style={styles.pictoLabel}>JUGO</Text>
                    </TouchableOpacity>
